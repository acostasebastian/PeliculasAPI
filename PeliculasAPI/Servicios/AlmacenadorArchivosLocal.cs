namespace PeliculasAPI.Servicios
{
    ...
    {
        private readonly IWebHostEnvironment env; //permite obtener la ruta de donde esta el wwwroot
        private readonly IHttpContextAccessor httpContextAccessor; // permite obtener el dominio para fabricar la url a guardar en la base de datos
