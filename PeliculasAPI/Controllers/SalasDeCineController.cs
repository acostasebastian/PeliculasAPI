    ...
    public class SalasDeCineController : CustomBaseController
    {
            ...
            [FromQuery] SalaDeCineCercanoFiltroDTO filtro)
        {
            ...
            var salasDeCine = await context.SalaDeCines
                ...
                .Where(x => x.Ubicacion.IsWithinDistance(ubicacionUsuario, filtro.DistanciaEnKms * 1000)) //para saber si está dentro de la distancia
                                                                                                          // y como está en metros se multiplica por 1000
