...
namespace PeliculasAPI.Controllers
{
    ...
    public class ReviewController : CustomBaseController
    {
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)] //solo usuarios autenticados pueden cargar una review de peliculas
        public async Task<ActionResult> Post(int peliculaId, [FromBody] ReviewCreacionDTO reviewCreacionDTO)
        {
            ...
            //Se agregan a la review, el ID de la pelicula y del usuario
