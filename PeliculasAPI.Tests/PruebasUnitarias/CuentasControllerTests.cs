...
namespace PeliculasAPI.Tests.PruebasUnitarias
{
    ...
    {
        [TestMethod]
        public async Task Registrar_DevuelveToken_CuandoEsExitoso() //CrearUsuario() en curso
        {
        ...
        [TestMethod]
        public async Task Login_DevuelveBadRequest_CuandoUsuarioNoExiste() //UsuarioNoPuedeLoguearse()
        {
            var nombreBD = Guid.NewGuid().ToString();
            await CrearUsuarioHelper(nombreBD);
        ...
        [TestMethod]
        public async Task Login_DevuelveToken_CuandoLoginEsCorrecto() //UsuarioPuedeLoguearse()
        {
            var nombreBD = Guid.NewGuid().ToString();
            await CrearUsuarioHelper(nombreBD);
