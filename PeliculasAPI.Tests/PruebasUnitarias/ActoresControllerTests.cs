...
namespace PeliculasAPI.Tests.PruebasUnitarias
{
    ...
    {
        [TestMethod]
        public async Task Get_ObtenerPersonasPaginadas_CuandoPaso3Actores()
        {
        ...
        [TestMethod]
        public async Task Post_DebeCrearActor_CuandoEnvioActorSinFoto()
        {
            var nombreBD = Guid.NewGuid().ToString();
            var contexto = ConstruirContext(nombreBD);
            var mapper = ConfigurarAutoMapper();
        ...
        [TestMethod]
        public async Task Post_DebeCrearActor_CuandoEnvioActorConFoto()
        {
            var nombreBD = Guid.NewGuid().ToString();
            var contexto = ConstruirContext(nombreBD);
            var mapper = ConfigurarAutoMapper();
        ...
        [TestMethod]
        public async Task Patch_Retorna404_SiActorNoExiste()
        {
            var nombreBD = Guid.NewGuid().ToString();
            var contexto = ConstruirContext(nombreBD);
            var mapper = ConfigurarAutoMapper();
        ...
        [TestMethod]
        public async Task Patch_ActualizaUnSoloCampo_CuandoSeLeEnviaUnaOperacion()
        {
            var nombreBD = Guid.NewGuid().ToString();
            var contexto = ConstruirContext(nombreBD);
            var mapper = ConfigurarAutoMapper();
