...
namespace PeliculasAPI.Tests.PruebasUnitarias
{
    ...
    {
        [TestMethod]
        public async Task Get_RetornaTodosGeneros_ObtenerTodosLosGeneros()
        {
            // Preparación
        ...
        [TestMethod]
        public async Task Get_Retorna404_ObtenerGeneroPorIdNoExistente()
        {
            var nombreBD = Guid.NewGuid().ToString();
            var contexto = ConstruirContext(nombreBD);
            var mapper = ConfigurarAutoMapper();
        ...
        [TestMethod]
        public async Task Get_RetornaGenero_ObtenerGeneroPorIdExistente()
        {
            var nombreBD = Guid.NewGuid().ToString();
            var contexto = ConstruirContext(nombreBD);
            var mapper = ConfigurarAutoMapper();
        ...
        [TestMethod]
        public async Task Post_DebeCrearGenero_CrearGenero()
        {
            var nombreBD = Guid.NewGuid().ToString();
            var contexto = ConstruirContext(nombreBD);
            var mapper = ConfigurarAutoMapper();
        ...
        [TestMethod]
        public async Task Put_ActualizaGenero_ActualizarGenero()
        {
            var nombreBD = Guid.NewGuid().ToString();
            var contexto = ConstruirContext(nombreBD);
            var mapper = ConfigurarAutoMapper();
        ...
        [TestMethod]
        public async Task Delete_Retorna404_IntentaBorrarGeneroNoExistente()
        {
            var nombreBD = Guid.NewGuid().ToString();
            var contexto = ConstruirContext(nombreBD);
            var mapper = ConfigurarAutoMapper();
        ...
        [TestMethod]
        public async Task Delete_BorraGenero_CuandoGeneroExiste()
        {
            var nombreBD = Guid.NewGuid().ToString();
            var contexto = ConstruirContext(nombreBD);
            var mapper = ConfigurarAutoMapper();
