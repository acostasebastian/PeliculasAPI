...
{
    [TestClass]
    public class LocalDbDatabaseInitializer // Esta clase se crea para simular el la libreria de NetTopologySuite,
                                            // usando una base de datos en LocalDb
    {
        private static readonly string _dbName = "PruebasDeIntegracion";

        [AssemblyInitialize]
        //Se ejecuta al inicio de un conjunto de pruebas unitarias, no en cada una
