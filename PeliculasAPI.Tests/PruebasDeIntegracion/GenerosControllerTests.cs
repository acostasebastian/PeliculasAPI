...
namespace PeliculasAPI.Tests.PruebasDeIntegracion
{
    ...
    public class GenerosControllerTests : BasePruebas
    {
        ...
        [TestMethod]
        public async Task Get_ObtenerTodosLosGenerosListadoVacio()
        {
        ...
        [TestMethod]
        public async Task Get_ObtenerTodosLosGeneros()
        {
            var nombreBD = Guid.NewGuid().ToString();
            var factory = ConstruirWebApplicationFactory(nombreBD);
        ...
        [TestMethod]
        public async Task Delete_BorrarGenero()
        {
            var nombreBD = Guid.NewGuid().ToString();
            var factory = ConstruirWebApplicationFactory(nombreBD);
        ...
        [TestMethod]
        public async Task Delete_BorrarGeneroRetorna401()
        {
            var nombreBD = Guid.NewGuid().ToString();
